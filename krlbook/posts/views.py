...
def like_unlike_post(request):
    ...
    if request.method == 'POST':
        ...
        dislike,create_d = Dislike.objects.get_or_create(user=profile, post_id=post_id)
...
@login_required
def dislike_unlike_post(request):
    user = request.user
    if request.method == 'POST':
        post_id = request.POST.get('post_id')
        post_obj = Post.objects.get(id=post_id)
        ...
        like, created_l = Like.objects.get_or_create(user=profile, post_id=post_id)
